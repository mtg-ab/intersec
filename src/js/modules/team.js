jQuery( document ).ready(function() {
    if(jQuery("section").hasClass("team")){
        ...
        ( function() {
            ...
            function Slider( newSlider, sliderSize, slideSize, animationDuration, autoplayInterval ) {
                ...
                this.btnLeft             = document.querySelector( 'button.previous' );
                this.btnRight             = document.querySelector( 'button.next' );
            ...
            window.circularSlider2 = new Slider( document.querySelector( '.circular-slider-2' ), 100, 15, 600, 2500 );
